...
def extract_node_id(node_pool: dict) -> str:
...
def get_first_worker_node_id(cluster) -> pulumi.Output:
    """
...
def get_first_worker_public_ip(cluster, vultr_provider) -> pulumi.Output:
    """
